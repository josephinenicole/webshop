...
if (isset($_SESSION['checkout']) && is_array($_SESSION['checkout'])) {
    ...
    $ids = implode(',', array_keys($_SESSION['checkout']));
        ...
        <form action="action_page.php" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-50">
              ...
              <input type="text" id="expdate" name="expdate" placeholder="September 2099">
              <div class="row">
              <div class="col-50">
      ...
      <div class="container">
        ...
        foreach($produkte as $produkt) {
          ...
          <div style="display: flex; justify-content: space-between;">
            <div style="text-align: left;"><?php printf($produkt->artikel) ?></div>
            <div style="text-align: right;"><?php printf("%0.2f €", $gesamtpreis) ?></div>
          </div>
          <br>     
        <?php
        }
        ?>
        <div style="display: flex; justify-content: space-between;">
          <div style="text-align: left;"> <b>Gesamtpreis:</b></div>
          <div style="text-align: right;"><?php printf("%0.2f €", $gesamtsumme) ?></div>
        </div>
      </div>
    </div>
